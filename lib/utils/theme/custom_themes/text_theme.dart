...
class TTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.black.withOpacity(0.5)),
  );
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.white.withOpacity(0.5)),
  );
}